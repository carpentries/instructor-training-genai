...
An entire book basically says "measuring programmers' productivity is really hard" over and over again [(Sadowski and Zimmerman 2019)](../learners/reference.md#Sadowski2019).
One reason is that much of software work is invisible: a field study found developers only spend 25% of their day actually writing code [(Meyer et al 2017)](../learners/reference.md#Meyer2017).
