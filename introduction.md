...
(For some guidelines on introducing yourself, see some content from the [Introductions section of Instructor Training](https://carpentries.github.io/instructor-training/23-introductions.html).)
...
<!-- Ideally, replace the MCQs below with an exercise to mark their place on a pair of axes for these questions. 
     We may be able to use tldraw.com to gather these responses and accumulate them over time. --->

2. **How often do you use genAI tools in your own work?**
    * Never
    * Rarely
    * Monthly
    * Weekly
...
3. **How helpful or unhelpful do you think genAI tools are for novices learning to code?**
    * Very helpful
    * Helpful
